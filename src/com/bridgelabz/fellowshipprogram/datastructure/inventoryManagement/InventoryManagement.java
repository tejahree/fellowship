...
public class InventoryManagement {
		...
		public static void main(String[] args) {
			...
			String filePath="/home/admin1/eclipse-workspace/JsonProject/inventory.json";
...
//			list.add(new Wheat("normal", 4, 42));
		/*	 Rice rice = new Rice(); 
			...
			//  rice.setTotal(totalRice);
			  rice.setTotalRice(totalRice);
			  int totalWheat=(list.ObjectWheat.get(0).getWeight())*(list.ObjectWheat.get(0).getPricePerKg());
			  Wheat wheat=new Wheat();
			 // wheat.setTotal(totalWheat);
			  wheat.setTotalWheat(totalWheat);
			  int totalPulses=(list.ObjectPulses.get(0).getWeight())*(list.ObjectWheat.get(0).getPricePerKg());
			  try {
		...
		/*	try {
			 ...
			 System.out.println(list.ObjectRice.get(0).getName()+"--->"+list.ObjectRice.get(0).getTotalRice());
			 System.out.println(list.ObjectWheat.get(0).getName()+"--->"+list.ObjectWheat.get(0).getTotalWheat());
			 System.out.println(list.ObjectPulses.get(0).getName()+"--->"+list.ObjectPulses.get(0).getTotalPulses());
